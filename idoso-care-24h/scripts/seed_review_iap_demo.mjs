/**
 * Garante taxa IAP pendente na conta demo do cuidador (revisão Apple).
...
console.log('Login cuidador demo…');
const cg = await signIn(CAREGIVER_EMAIL, apiKey);
...
console.log('Acumulando taxa pendente US$ 1,99 no cuidador…');
...
console.log('OK — cuidador demo com taxa pendente US$ 1,99 (1 diária).');
console.log('UID cuidador:', caregiverUid);
