# Guia completo — Site legal e App Store Connect (Babá ON)

Documento de referência para **não ser reprovado** na revisão da Apple App Store. Baseado no aplicativo real (web-app + Firebase + build iOS `com.babaon.app`).
...
| Arquivo | URL pública |
|---------|-------------|
| `legal.html` | https://baba-on.web.app/legal.html |
| `privacidade.html` | https://baba-on.web.app/privacidade.html |
| `termos.html` | https://baba-on.web.app/termos.html |
| `suporte.html` | https://baba-on.web.app/suporte.html |
| `exclusao-conta.html` | https://baba-on.web.app/exclusao-conta.html |
...
|-------|-------------------|
| **Política de Privacidade** | `https://baba-on.web.app/privacidade.html` |
| **URL de suporte** | `https://baba-on.web.app/suporte.html` |
| **URL de marketing** (opcional) | `https://baba-on.web.app/legal.html` |
...
- Taxa plataforma **US$ 1,99** fixa por negócio fechado — exclusivamente Apple IAP produto `bo_taxa_manutencao`
...
```
App: Babá ON — marketplace que conecta famílias a cuidadores de idosos no Brasil.
...
Pagamentos:
  ...
  - Taxa plataforma US$ 1,99: exclusivamente Apple IAP (bo_taxa_manutencao)

Permissões:
  - Câmera/galeria: documentos e foto de perfil apenas
  - Sem localização GPS contínua

Privacidade: https://baba-on.web.app/privacidade.html
Suporte: https://baba-on.web.app/suporte.html
Exclusão de conta: https://baba-on.web.app/exclusao-conta.html
```
...
**Babá ON** conecta famílias a cuidadores profissionais de idosos com segurança e transparência.
...
**Importante:** o Babá ON não presta serviços médicos nem de emergência. Em emergência, ligue 192 ou 190.
...
|------------|------|------|
| `bo_taxa_manutencao` | Consumível | Taxa de manutenção Babá ON |

Descrição IAP: “Taxa de manutenção da plataforma Babá ON — US$ 1,99 por negócio fechado.”
...
- `IdosoCare24H/baba_on_app/web_app/`
- `TrocaCopa2026/troca_copa_app/baba-on/web_app/`
