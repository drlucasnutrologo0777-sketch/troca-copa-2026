...
/// Tela principal do médico — status, dados cadastrados e orientações do app.
    ...
    return AppScaffold(
      ...
      child: StreamBuilder(
        ...
        builder: (context, snapshot) {
          ...
          final name = data?['fullName'] as String? ?? profile?.fullName ?? 'Médico';
              ...
              children: [
                  ...
                  children: [
                    ...
                    if (!approved)
                      const Padding(
                        ...
                        child: Text(
                          'A equipe Medico de Casa analisa CRM e documentos em até 48 horas úteis. '
                ...
                _SectionCard(
                  ...
                  children: const [
                    _StepRow(
                      number: '1',
                      text: 'Você completa o cadastro como médico (endereço, bio, valores).',
                    ),
                    SizedBox(height: 10),
                    _StepRow(
                      number: '2',
                    ...
                    _StepRow(
                      number: '3',
                      text: 'Famílias buscam médicos na aba Buscar e abrem seu perfil.',
                    ),
                    SizedBox(height: 10),
                    _StepRow(
                      number: '4',
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  approved
                      ? 'Pacientes já podem encontrar você na plataforma Medico de Casa.'
